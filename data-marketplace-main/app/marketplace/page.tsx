      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Discover and explore data products that power your projects. Find the perfect datasets, APIs, ML models, and data warehouses for your needs.
          </p>
        </div>
        ...
        <div className="mb-8 space-y-4">
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            <Input
              type="search"
              placeholder="Search datasets, APIs, models, warehouses..."
