                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        placeholder="e.g., Battle Royale Analytics Dataset"
                      />
                    </div>
                    <div className="grid gap-2">
                    ...
                    <div className="bg-muted p-3 rounded-lg">
                      <p className="text-sm text-muted-foreground">
                        ...
                        from {Object.keys(getGameStats().reduce((acc, [game]) => ({ ...acc, [game]: true }), {})).length} different games.
                      </p>
                    </div>
                  </div>
                  <DialogFooter>
              ...
              <div className="flex items-center justify-center py-24">
                <div className="text-center max-w-md">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Start building your data collection by adding datasets, APIs, and ML models from the marketplace.
                  </p>
                  <Button asChild>
                    <a href="/marketplace">Browse Data Marketplace</a>
                  </Button>
                </div>
              </div>
            ) : (
