...
export default function DataSourceDetailPage() {
  ...
  const handleViewInAlation = () => {
    toast.info("Opening in Alation", {
      description: "Redirecting to Alation..."
    });
    // Open Alation link
    window.open("https://alation.com", "_blank");
  };
                    ...
                    <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                      ...
                      <div className="space-y-2">
                        <Button 
                          size="sm"
                          onClick={() => {
                            toast.success("Shared with LCM team");
                          }}
                        ...
                        <Button 
                          size="sm"
                          onClick={() => {
                            toast.success("Opening with Looker ML...");
                          }}
              ...
              <Card className="border-2">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-semibold mb-2 text-sm text-muted-foreground">Game Title</h4>
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed">
                      This data source supports {dataSource.category.toLowerCase()} analysis and decision-making for {dataSource.game_title}, 
                      enabling stakeholders to understand player behavior, optimize game mechanics, and drive business growth.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2 text-sm text-muted-foreground">Business Impact</h4>
                    <p className="text-sm leading-relaxed">
                      Critical for understanding {dataSource.genre.toLowerCase()} game dynamics, player engagement patterns, 
                      and revenue optimization strategies. Used by product managers, analysts, and executives for strategic planning.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <div className="bg-muted p-3 rounded-md text-sm font-mono space-y-1">
                      <div>player_id: UUID (Primary Key)</div>
                      <div>session_id: VARCHAR(50)</div>
                      <div>game_mode: ENUM(&apos;casual&apos;, &apos;ranked&apos;, &apos;tournament&apos;)</div>
                      <div>start_time: TIMESTAMP</div>
                      <div>end_time: TIMESTAMP</div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-1">
                      <li>• players.id → player_sessions.player_id</li>
                      <li>• games.id → player_sessions.game_id</li>
                      <li>• achievements.id → player_sessions.achievements</li>
                    </ul>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-1">
                      <li>• player_id must be valid UUID format</li>
                      <li>• start_time cannot be future date</li>
                      <li>• score must be non-negative integer</li>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <div className="bg-muted p-3 rounded-md text-sm">
                      Game Client → Kafka → Spark Streaming → PostgreSQL → Analytics Layer
                    </div>
                  </div>
                  <div>
