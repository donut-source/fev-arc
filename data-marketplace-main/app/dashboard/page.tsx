...
const userCollections = [
  {
    id: "1",
    name: "Gaming Analytics Q1 2024",
    description: "Player behavior and engagement metrics for Q1",
    itemCount: 12,
  ...
  {
    id: "2", 
    name: "Battle Royale Performance Data",
    description: "Performance metrics across multiple BR games",
    itemCount: 8,
...
const userDataAssets = [
  {
    id: "1",
    title: "Operation Killshot Preorder Analytics",
    type: "dataset",
    category: "Marketing Analytics",
    game: "Operation Killshot",
    accessLevel: "read",
  ...
  {
    id: "2",
    title: "Cosmic Carnival Event Analytics",
    type: "api",
    category: "Event Analytics", 
    game: "Cosmic Carnival",
  ...
  {
    id: "3",
    title: "Dragon Empire Economy Model",
    type: "model",
...
const userTools = [
  {
    id: "1",
    name: "Player Segmentation Tool",
    description: "Advanced player clustering and segmentation",
    category: "Analytics",
    lastUsed: "2024-01-13",
    usageCount: 47,
  },
  {
    ...
    description: "Statistical testing for game features",
  ...
  },
  {
    ...
    description: "ML-based revenue prediction tool",
    category: "Finance",
    lastUsed: "2024-01-09",
    usageCount: 15,
  },
...
const teamMembers = [
  {
    ...
    avatar: null,
    isOnline: true,
    expertise: ["Machine Learning", "Player Analytics", "A/B Testing"],
  },
  {
    id: "2",
    name: "Mike Rodriguez", 
    ...
    avatar: null,
    isOnline: false,
    expertise: ["Data Pipeline", "ETL", "Cloud Infrastructure"],
  },
  {
    id: "3",
    name: "Alex Kim",
    ...
    avatar: null,
    isOnline: true,
    expertise: ["Product Analytics", "User Research", "Dashboard Design"],
  },
];
        ...
        <div className="grid gap-4 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="flex items-center text-xs text-muted-foreground mt-2">
                <span>Gaming Analytics team</span>
              </div>
            </CardContent>
          </Card>
        </div>
