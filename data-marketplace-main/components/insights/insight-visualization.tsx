...
export function InsightVisualization({ insightType, title, metrics }: InsightVisualizationProps) {
  ...
  const generateDashboard = (commonLayout: any) => {
    if (title.includes('Player Engagement')) {
      // Multi-chart dashboard for player engagement
      const data = [
        {
          type: 'indicator',
  ...
  const generateChart = (commonLayout: any) => {
  ...
  const generateReport = (commonLayout: any) => {
  ...
  const generateAnalysis = (commonLayout: any) => {
  ...
  const generateGenericDashboard = (commonLayout: any) => {
    const data = [
      {
        type: 'indicator',
        mode: 'gauge+number',
