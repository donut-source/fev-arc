...
const recentAssets = [
  {
    id: "1",
    name: "Player Engagement Metrics",
    type: "dataset",
    team: "Analytics",
    status: "ready",
    lastUpdated: "2 hours ago",
    governance: 98,
    description: "Daily active users, session duration, retention metrics",
  },
  {
    id: "2", 
    name: "Game Economy API",
    type: "api",
    team: "Game Services",
    status: "ready",
    lastUpdated: "4 hours ago",
    governance: 95,
    description: "Real-time in-game purchase and currency data",
  },
  {
    id: "3",
  ...
  {
    id: "4",
    name: "Game Analytics Warehouse",
    type: "warehouse",
    team: "Data Platform",
    status: "ready",
    lastUpdated: "6 hours ago",
    governance: 92,
    description: "Centralized analytics data warehouse for all games",
  },
];
...
const quickActions = [
  {
    ...
    description: "Explore all available data assets",
    href: "/catalog",
    icon: Database,
    color: "text-blue-600",
  },
