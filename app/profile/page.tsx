...
const initialProfile: UserProfile = {
  ...
  bio: "Alternative data analyst supporting private equity diligence, valuation, and portfolio monitoring. Focused on building governed, repeatable data products.",
  expertise: ["FX Rates", "Company Intelligence", "Valuation", "Real Estate Signals", "Python", "SQL"],
  yearsExperience: "5-7 years",
  education: "MS in Data Science, UC Berkeley",
  certifications: ["Power BI (Internal)", "Data Governance (Internal)"],
  preferredTools: ["Python", "SQL", "Power BI", "Looker", "FEV AI Space"],
  avatar: null,
};
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Deal Team">Deal Team</SelectItem>
                        <SelectItem value="Portfolio Operations">Portfolio Operations</SelectItem>
