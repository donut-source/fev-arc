...
const cloudPlatforms: CloudPlatform[] = [
  {
    id: "fev-ml-workbench",
    name: "FEV ML Workbench",
    icon: Brain,
    color: "bg-purple-600",
    description: "FEV Analytics ML modeling environment",
    projectExample: "fev-ml-workspace",
    tableExample: "pe_analytics.valuation_models"
  },
  {
    id: "snowflake",
    name: "Snowflake",
    ...
    projectExample: "ANALYTICS_PROD.PE_DATA",
    tableExample: "ALT_DATA_FX_VALUATIONS"
  },
  {
    id: "bigquery",
    name: "BigQuery",
    ...
    projectExample: "pe-analytics-prod",
    tableExample: "alt_data.fx_company_intel"
  },
  {
    id: "databricks",
    name: "Databricks",
    ...
    projectExample: "pe-workspace",
    tableExample: "alt_data_catalog.valuation_comps"
  }
];
